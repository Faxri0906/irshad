...
const Main = () => {
  return (
    <div className="container mt-5">
        <div className="gap-5 flex mt-5 flex-col lg:flex-row">
                    <img src={image} className="rounded-xl border-[2px] border-gray-400 max-w-[876px] max-h-[422px] lg:w-[600px] 2xl:w-[876px]"/>
                    <div className="lg:w-full border-[2px] border-yellow-400 rounded-xl">
                        <div className="flex bg-yellow-400 font-semibold p-4 rounded-t-lg gap-20 text-xl">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex gap-2.5 p-4">
                                <div className="flex flex-col">
                                    ...
                                    <h1 className="lg:font-semibold font-medium lg:text-[22px] text-base">449.99 AZN</h1>
                                </div>
        ...
        <div className="bg-gray-100 mt-[22px] w-full rounded-xl h-40 md:flex justify-between px-14 py-10 mb-16 hidden">
